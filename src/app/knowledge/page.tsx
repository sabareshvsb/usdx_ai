      ...
      <div className="max-w-[1100px] mx-auto">
        <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-end">
          ...
          <Link
            ...
            className="inline-flex shrink-0 items-center gap-2 rounded-[10px] bg-accent-blue/10 border border-accent-blue/20 px-4 py-2 text-[12px] font-semibold text-accent-blue transition-colors hover:bg-accent-blue/20"
          >
